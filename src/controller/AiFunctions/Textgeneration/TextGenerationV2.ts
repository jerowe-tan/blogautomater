...
import masterOfSEOGeneral from "../Rules/masterOfSEOGeneral";
import masterOfSummary from "../Rules/masterOfSummary";
import masterOfTitleGeneratorGeneral from "../Rules/masterOfTitleGeneratorGeneral";
import masterOfTopicGenerator from "../Rules/masterOfTopicGenerator";

export async function aiSuggestBlogContent(AI:Ai, topic:BASE64EX_STRING){
  // const tasks = [];
...
export async function aiSuggestBlogTitle(AI:Ai, newsData:BASE64EX_STRING){
  // const tasks = [];
  const model = "@cf/meta/llama-3.3-70b-instruct-fp8-fast";
  const messages = [
    masterOfTitleGeneratorGeneral,
...
export async function aiSuggestKeywords(AI:Ai, summary:string){
  const model = "@cf/meta/llama-3.3-70b-instruct-fp8-fast";
  const messages = [
...
export async function aiSuggestDescription(AI:Ai, content:string){
  const model = "@cf/meta/llama-3.3-70b-instruct-fp8-fast";
  const messages = [
    masterOfSummary,
